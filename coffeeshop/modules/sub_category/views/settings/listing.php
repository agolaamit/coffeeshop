<div class="admin-box">
    ...
    ?>
    <h3><b><?php echo $cat_name; ?>'s Sub Category</b></h3>
            ...
            <?php if (isset($records) && is_array($records) && count($records)) : ?>
                <?php foreach ($records as $record) : ?>
                    <tr>
                        ...
                        <td><?php echo $cat ?></td>
                        <td><?php echo anchor(SITE_AREA . '/settings/sub_category/attribute_listing/' . $record->id, "View Attributes") ?></td>
                        <?php if ($this->auth->has_permission('Sub_Category.Settings.Edit')) : ?>
                            <td><?php echo anchor(SITE_AREA . '/settings/sub_category/edit/'.$this->uri->segment(5).'/'. $record->id, '<i class="icon-pencil">&nbsp;</i>') ?></td>
                        <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
<?php else: ?>
