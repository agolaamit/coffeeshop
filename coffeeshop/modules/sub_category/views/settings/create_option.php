...
?>
<div class="admin-box">
    <h3><b>Create Attribute Option</b></h3>
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        
        <div class="control-group <?php echo form_error('option_name') ? 'error' : ''; ?>">
        <?php echo form_label('Option Name' . lang('bf_form_label_required'), 'title', array('class' => "control-label")); ?>
            <div class='controls'>
        ...
        <div class="form-actions">
            <br/>
            <input type="hidden" name="sub_cat_attr_id" id="sub_cat_attr_id" value="<?php echo $this->uri->segment(5); ?>" />
            <input type="submit" name="save" class="btn btn-primary" value="Create Option" />
            or <?php echo anchor(SITE_AREA . '/settings/sub_category', lang('sub_category_cancel'), 'class="btn btn-warning"'); ?>
