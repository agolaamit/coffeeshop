...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Sub_Category.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Sub_Category.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_sub_category())
			{
				...
				Template::redirect(SITE_AREA .'/reports/sub_category');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/sub_category');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Sub_Category.Reports.Edit');
		...
		{
			$this->auth->restrict('Sub_Category.Reports.Delete');
