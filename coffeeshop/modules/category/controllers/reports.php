...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Category.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Category.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_category())
			{
				...
				Template::redirect(SITE_AREA .'/reports/category');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/category');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Category.Reports.Edit');
		...
		{
			$this->auth->restrict('Category.Reports.Delete');
