...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create order" />
            or <?php echo anchor(SITE_AREA .'/developer/order', lang('order_cancel'), 'class="btn btn-warning"'); ?>
