...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Order.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Order.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_order())
			{
				...
				Template::redirect(SITE_AREA .'/settings/order');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Order.Settings.Edit');
		...
		{
			$this->auth->restrict('Order.Settings.Delete');
