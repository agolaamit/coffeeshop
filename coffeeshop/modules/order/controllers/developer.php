...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Order.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Order.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_order())
			{
				...
				Template::redirect(SITE_AREA .'/developer/order');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Order.Developer.Edit');
		...
		{
			$this->auth->restrict('Order.Developer.Delete');
