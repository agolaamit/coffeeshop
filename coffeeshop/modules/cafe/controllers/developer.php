...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Cafe.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Cafe.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_cafe())
			{
				...
				Template::redirect(SITE_AREA .'/developer/cafe');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/cafe');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Cafe.Developer.Edit');
		...
		{
			$this->auth->restrict('Cafe.Developer.Delete');
