...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Cafe.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Cafe.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_cafe())
			{
				...
				Template::redirect(SITE_AREA .'/content/cafe');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/cafe');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Cafe.Content.Edit');
		...
		{
			$this->auth->restrict('Cafe.Content.Delete');
