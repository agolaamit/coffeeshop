...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Cafe.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Cafe.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_cafe())
			{
				...
				Template::redirect(SITE_AREA .'/reports/cafe');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/cafe');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Cafe.Reports.Edit');
		...
		{
			$this->auth->restrict('Cafe.Reports.Delete');
