...
abstract class REST_Controller extends MX_Controller
{
	...
	*/
	...
	{
                //print_r($this->_post_args); exit;
                $json_array=($this->_post_args['json']);
                //print_r($json_array); exit;

                //print_r($this->_post_args['json']); exit;
		...
		$controller_method = $json_array['callback'];
		//$controller_method = $this->request->callback.'_'.$this->request->method;
