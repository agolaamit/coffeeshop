...
class Settings extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->auth->restrict('Coffeeshop.Users.View');

        $this->load->model('roles/role_model');
        $this->load->model('cafe/cafe_model');
...
//end __construct()
    ...
    {
        $this->auth->restrict('Coffeeshop.Users.Manage');
...
//end index()
    ...
    {
        $this->auth->restrict('Coffeeshop.Users.Add');
        ...
        Template::set('cafes', $this->cafe_model->select('id, cafe_name')->where('cafe_status', '0')->find_all());
...
//end access_logs()
    ...
    private function save_user($type = 'insert', $id = 0, $meta_fields = array(), $cur_role_name = '')
    {
        ...
        if (has_permission('Coffeeshop.Roles.Manage') && has_permission('Permissions.' . $cur_role_name . '.Manage'))
        {
