...
class Base_Controller extends MX_Controller
{
	...
	public function __construct()
	{
		...
		*/
		...
		{
			if ($this->settings_lib->item('site.show_front_profiler') AND has_permission('Coffeeshop.Profiler.View'))
			{
				// Profiler bar?
 ...
 *
 * @package    Coffeeshop\Core\Controllers
 * @category   Controllers
 * @author     Coffeeshop Dev Team
 * @link       http://guides.ciCoffeeshop.com/helpers/file_helpers.html
 *
 */
...
class Admin_Controller extends Authenticated_Controller
{
	...
	public function __construct()
	{
		...
		{
			if ($this->settings_lib->item('site.show_profiler') AND has_permission('Coffeeshop.Profiler.View'))
			{
				// Profiler bar?
				if ( ! $this->input->is_cli_request() AND ! $this->input->is_ajax_request())
				{
