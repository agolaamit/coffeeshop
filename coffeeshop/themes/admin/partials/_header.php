...
<html lang="en">
    ...
    <body class="desktop">
        ...
        <noscript>
        <p>Javascript is required to use Coffeeshop's admin.</p>
        </noscript>
        ...
        <div class="navbar navbar-fixed-top" id="topbar" >
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <ul class="nav">
                        <li ><a href="<?php echo site_url(SITE_AREA . '/settings/users') ?>" class="active" title="User"><?php if($this->uri->segment(3)=='users'){ ?><b style="color: white;">Users</b> <?php }else{ ?>Users <?php } ?></a>
                        </li>
                        <li ><a href="<?php echo site_url(SITE_AREA . '/settings/cafe') ?>" class="" title="Cafe"><?php if($this->uri->segment(3)=='cafe'){ ?><b style="color: white;">Cafe</b> <?php }else{ ?>Cafe<?php } ?></a>
                        </li>
                        <li ><a href="<?php echo site_url(SITE_AREA . '/settings/category') ?>" class="" title="Category"><?php if($this->uri->segment(3)=='category'){ ?><b style="color: white;">Category</b> <?php }else{ ?>Category<?php } ?></a>
                        </li>
                        <li ><a href="<?php echo site_url(SITE_AREA . '/settings/product') ?>" class="" title="Product"><?php if($this->uri->segment(3)=='product'){ ?><b style="color: white;">Product</b> <?php }else{ ?>Product<?php } ?></a>
                        </li>
                    </ul>
